...
- žádná původní funkční větev nebyla odstraněna; původní Perplexity Search zůstává zachovaná
...
2. **Původní Perplexity Search zůstává zachovaný**
   - původní provider `perplexity-search` zůstává v aplikaci i databázové synchronizaci
   - nebyl nahrazen ani smazán

3. **Exa Research launcher**
